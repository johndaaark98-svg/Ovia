...
// La chiave WEBHOOK_API_KEY non è mai nel codice del sito: sta nelle
// Environment Variables di Vercel (nome: BASE44_WEBHOOK_KEY).
// Percorso di questo file nel repository: api/lead.js
// Endpoint pubblico una volta deployato: https://<tuo-progetto>.vercel.app/api/lead
...
// Deve corrispondere esattamente ai valori enum "pacchetto_suggerito" su Base44.
const PACKAGE_NAMES = [
  'Ovia Second Brain',
  'Ovia Inbox',
  'Ovia Documenti',
...
export default async function handler(req, res) {
  ...
  // Il sito manda i campi grezzi; qui li puliamo e normalizziamo
  // prima di inoltrarli a Base44, che ha vincoli di tipo enum.
  const payload = {
    nome: body.nome || '',
  ...
  // Campi opzionali per gli appuntamenti Process Check, se presenti.
